...
export const SecurityAndSovereignty: React.FC<{ onNavigateToContact?: () => void }> = ({
  ...
  return (
    <section id="security" className="py-28 bg-[#050508] border-t border-white/[0.06] relative overflow-hidden">
      {/* Background illumination */}
      <div className="absolute top-1/2 left-1/4 w-[600px] h-[600px] bg-emerald-600/5 rounded-full blur-[160px] pointer-events-none" />
      ...
      <div className="w-full px-[5%] max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-950/40 border border-emerald-700/30 text-emerald-300 text-xs font-semibold uppercase tracking-wider mb-4">
            ...
            <h2 className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight leading-tight font-display mb-4">
              ...
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-300 to-sky-300">
          ...
          {onNavigateToContact && (
            <button
              ...
              className="px-5 py-3 rounded-xl bg-emerald-950/50 hover:bg-emerald-900/60 text-emerald-300 border border-emerald-700/40 text-xs font-bold transition-all flex items-center gap-2 self-start md:self-end"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {pillars.map((pil, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-7 rounded-3xl bg-[#09090f] border border-white/[0.08] hover:border-emerald-500/40 transition-all duration-300 flex flex-col justify-between group"
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <div className="w-10 h-10 rounded-xl bg-emerald-950/50 border border-emerald-700/40 text-emerald-400 flex items-center justify-center group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                  ...
                  <h3 className="text-lg font-bold text-white font-display mb-2 group-hover:text-emerald-200 transition-colors">
                    {pil.title}
                  </h3>
                ...
                <div className="mt-6 pt-4 border-t border-white/[0.06] flex items-center gap-1.5 text-xs text-emerald-400 font-mono-code font-semibold">
